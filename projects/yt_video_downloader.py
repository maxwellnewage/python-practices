...
INSTRUCTIONS_DEFAULT_TEXT = "Escribe un link y presiona descargar para empezar!"
...
# Título
title_label = Label(frame, text="YouTube Video Downloader", font=("Helvetica", 18))
title_label.grid(row=0, column=0, columnspan=2, padx=5, pady=10)

# Instrucciones
instructions_label = Label(frame, textvariable=string_var_instructions, font=("Helvetica", 14))
